...
create table student_academic_info(roll_number varchar(20) primary key references student_18(roll_number),
...
insert into student_academic_info values('CB.EN.U4CSE18001',8,9,7,13,12.5,11.25,14,48,47,18,17);
insert into student_academic_info values('CB.EN.U4CSE18002',9,7,10,13,12.5,11.25,15,48,45,18,17);
insert into student_academic_info values('CB.EN.U4CSE18003',8,9,7,10,12.5,9.25,14,44,47,18,17);
insert into student_academic_info values('CB.EN.U4CSE18004',10,9,7,13,12.5,10.25,14,48,47,18,20);
insert into student_academic_info values('CB.EN.U4CSE18005',10,10,7,13,13.5,11.25,15,48,47,18,17);
insert into student_academic_info values('CB.EN.U4CSE18006',9,9,10,13,14.5,13.25,14,48,49,20,17);
insert into student_academic_info values('CB.EN.U4CSE18007',8,9,9,13,12.75,14.25,14,48,47,20,17);
insert into student_academic_info values('CB.EN.U4CSE18008',10,9,10,13,12.5,11.25,40,48,47,18,17);
insert into student_academic_info values('CB.EN.U4CSE18009',8,9,7,13,14.5,11.25,14,50,47,18,20);
insert into student_academic_info values('CB.EN.U4CSE18010',10,9,9,13,12.5,15,14,48,50,20,19);
select * from student_academic_info;

select * from student_academic_info where roll_number='CB.EN.U4CSE18001';
